...
<head>
    ...
    <meta property="og:title" content="聞々ハヤえもんで音程を変更する方法" />
         ...
         style="margin:20px 25px 40px 25px; line-height: 150%;text-align:left;background-image:url();background-repeat:no-repeat">
            <div style="margin-left:60px;margin-right:60px">
                <div class="font20" style="text-align:center;margin-bottom:40px;">
                    <div class="font40" style="padding-top:40px;margin-bottom:20px;font-weight:bold">聞々ハヤえもんで音程を変更する方法
                    </div>
                    <div class="font30" style="color:#808080;font-weight:bold">音程を、あなたの意のままに。</div>
                    <br />
                    <center>
                    ...
                    <br /><br />
                    このページでは、聞々ハヤえもんで音程を変更する方法を説明します。<br />
                ...
                <div style="margin-left:20px">
                    あらゆる音楽ソフトの中でも聞々ハヤえもんは、最も簡単に音程を変更することができます。<br />
                    <br />
                    音程を変更する方法は、音程のつまみをドラッグして動かすだけです。<br />
                    <br />
                    音楽を再生しながら、いつでもリアルタイムに音程を変更することができます。<br />
                    <br />
                    左側のエディットボックスに直接値を入力することでも、音程を変更することができます。
                </div>
                <br /><br />
                <div style="float:left">
                    <a href="changefrequency.php" class="font22 lbtn" style="text-decoration:underline">聞々ハヤえもんで再生周波数を変更する方法</a>
                </div>
                <div style="float:right;text-align:right">
                    <a href="savefile.html" class="font22 btn" style="text-decoration:underline">聞々ハヤえもんで変換ファイルを保存する方法</a>
                </div>
                <br /><br />
                <center>
