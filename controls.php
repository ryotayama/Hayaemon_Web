...
<head>
    ...
    <meta property="og:title" content="聞々ハヤえもんでコントロールの表示状態を切り替える方法" />
    ...
    <title>聞々ハヤえもんでコントロールの表示状態を切り替える方法</title>
         ...
         style="margin:20px 25px 40px 25px; line-height:150%;text-align:left;background-image:url();background-repeat:no-repeat">
            <div style="margin-left:60px;margin-right:60px">
                <div class="font20" style="text-align:center;margin-bottom:40px;">
                    <div class="font40" style="padding-top:0px;margin-bottom:20px;font-weight:bold;line-height:150%">
                        聞々ハヤえもんでコントロールの<br />
                        表示状態を切り替える方法
                    </div>
