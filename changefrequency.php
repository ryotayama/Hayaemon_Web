...
<head>
    ...
    <meta property="og:title" content="聞々ハヤえもんで再生周波数を変更する方法" />
    ...
    <meta property="og:url" content="http://hayaemon.jp/about.html" />
    <meta property="og:image" content="http://hayaemon.jp/icon.png" />
    <title>聞々ハヤえもんで再生周波数を変更する方法</title>
...
<div style="border:1px solid #e0e0e0;border-radius:5px">
    <div class="font15"
         style="margin:20px 25px 40px 25px; line-height: 150%;text-align:left;background-image:url();background-repeat:no-repeat">
            <div style="margin-left:60px;margin-right:60px">
                <div class="font20" style="text-align:center;margin-bottom:40px;">
                    <div class="font40" style="padding-top:40px;margin-bottom:20px;font-weight:bold">
                        聞々ハヤえもんで再生周波数を変更する方法
                    </div>
                ...
                <div class="font26" style="margin-top:60px;margin-bottom:20px;font-weight:bold">つまみを動かすだけ。</div>
                <div style="margin-left:20px">
                    あらゆる音楽ソフトの中でも聞々ハヤえもんは、最も簡単に再生周波数を変更することができます。<br />
                    <br />
                    再生周波数を変更する方法は、再生周波数のつまみをドラッグして動かすだけです。<br />
                    <br />
                    音楽を再生しながら、いつでもリアルタイムに再生周波数を変更することができます。<br />
                    <br />
                    左側のエディットボックスに直接値を入力することでも、再生周波数を変更することができます。
                </div>
                <br /><br />
                <div style="float:left">
                    <a href="whychangespeed.php" class="font23 lbtn" style="text-decoration:underline">音声の再生速度を変えることで何ができるのか</a>
                </div>
